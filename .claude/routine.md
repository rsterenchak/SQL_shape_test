...
This file documents the project-specific commands, conventions, and quirks for **SQL_shape_test.git**. It supplements `routine-base.md` (which has the universal discipline) with project-specific details Claude runs need to know.
...
**Deploy target:** GitHub Pages (source manifest only — no app deploy)
...
>
> - "SQL_shape_test.git is a single-page app; routing is hash-based via {{ROUTER_FILE}}."
