...
- `drafted`:
  `{"state":"drafted","draft":"<full TODO.md entry>","file_paths":["...","..."],"thread":[{"role":"agent","text":"Drafted — ready to dispatch.","ts":"<now>"}]}`
...
- File paths full and repo-relative — `<file>`, never a bare filename.
  Source under ``, tests under `tests/`.
