...
**Files to fill in:**
- [ ] Replace `SQL_shape_test.git` everywhere in this file with this project's name (the repo name is usually fine: e.g. `my-app`, `react-thing`, `cool-project`).
...
- [ ] Replace `GitHub Pages (source manifest only — no app deploy)` with where the project deploys (e.g. `GitHub Pages`, `Cloudflare Pages`, `Vercel`, or `none — library, no deploy`).
...
**Project name:** SQL_shape_test.git
...
**Deploys to:** GitHub Pages (source manifest only — no app deploy)
